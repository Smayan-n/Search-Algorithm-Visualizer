...
class CreateMazeUI(QWidget):
    ...
    def preSolve(self):
        ...
        mazeWin = SolveMazeUI(mainWin=self.mainWin, option="solve", maze_template = self.maze_template)
