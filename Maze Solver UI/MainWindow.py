...
# from utilities.maze_text_to_array_converter import convertTextFile
...
class MainWindow(QMainWindow):
    ...
    def loadMaze(self):
        try:
            ...
            filePath = self.fileDialog.getOpenFileName(
                self, "Open a maze", "", "Text Files (*.txt)"
            )[0]
    ...
    def saveMaze(self, maze_cells):
        try:
            ...
            filePath = self.fileDialog.getSaveFileName(
                self, "Save Maze", "", "Text files (*.txt)"
            )[0]
